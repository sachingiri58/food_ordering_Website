$(function () {
  ...
  $("#linkedin-btn").click(function () {
    window.open("https://www.linkedin.com/in/sachingiri58", "_blank");
  });

  $("#github-btn").click(function () {
    window.open("https://github.com/sachingiri58", "_blank");
  });

  $("#email-btn").click(function () {
    window.location.href = "mailto:sachingiri58@gmail.com";
  });

  $("#instagram-btn").click(function () {
    window.open("https://www.instagram.com/sachingiri1_/", "_blank");
  });
});
